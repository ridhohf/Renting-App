...
function ResetPasswordContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Gagal mereset kata sandi atau token kedaluwarsa');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="double-bezel-inner p-6 sm:p-8">
            <div className="text-center space-y-2 mb-6">
              ...
              <p className="text-xs text-warm-muted">
                {success ? 'Kata sandi berhasil diperbarui' : 'Buat kata sandi baru untuk akun Anda'}
              </p>
            </div>
            ...
            {success ? (
              <div className="space-y-5 text-center py-4">
                ...
                <div className="space-y-1">
                  <h3 className="font-serif text-lg font-bold text-warm-dark">Berhasil Diperbarui!</h3>
